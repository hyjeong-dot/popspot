...
| **일반회원** | 팝업을 이용하는 사용자 | + 찜하기, 댓글, 수정제안, 신고, 경로 플래너, 1:1 문의, 예약 |
...
|  ID   | 기능      | 설명                                  | 우선순위 |
| :---: | --------- | ------------------------------------- | :------: |
|  U15  | 예약 하기 | 날짜/시간/인원 선택 및 예약 (유/무료) |    P2    |
|  U16  | 결제 하기 | 유료 입장권 결제 (PG사 연동)          |    P2    |
|  U17  | 예약 취소 | 예약 취소 및 환불                     |    P2    |
...
|  ID   | 기능        | 설명                            | 우선순위 |
| :---: | ----------- | ------------------------------- | :------: |
|  B08  | 예약 설정   | 회차별 시간, 정원, 입장료 설정  |    P2    |
|  B09  | 예약자 목록 | 회차별 예약자 확인 및 입장 처리 |    P2    |

#### 3.2.4 부가 기능 (일반회원)

|  ID   | 기능        | 설명                            | 우선순위 |
| :---: | ----------- | ------------------------------- | :------: |
|  U18  | 경로 플래너 | 찜한 팝업들 최적 경로 생성      |    P2    |
|  U19  | 주변 맛집   | 팝업 주변 맛집 리스트           |    P3    |
|  U20  | 알림 설정   | 찜한 팝업/오픈 예정 알림 on/off |    P2    |
|  U21  | 알림 내역   | 수신된 알림 목록 확인           |    P2    |

#### 3.2.5 고객 지원

|  ID   | 기능          | 설명                  | 우선순위 |
| :---: | ------------- | --------------------- | :------: |
|  U22  | 공지사항 목록 | 관리자 공지 목록      |    P2    |
|  U23  | 공지사항 상세 | 공지 내용 확인        |    P2    |
|  U24  | 1:1 문의 작성 | 관리자에게 문의       |    P2    |
|  U25  | 내 문의 목록  | 문의 내역 + 답변 확인 |    P2    |

#### 3.2.6 마이페이지

|  ID   | 기능         | 설명                  | 우선순위 |
| :---: | ------------ | --------------------- | :------: |
|  U26  | 내 정보 수정 | 닉네임, 비밀번호 변경 |    P1    |
|  U27  | 찜 목록      | 찜한 팝업 모아보기    |    P1    |
|  U28  | 내 댓글      | 작성한 댓글 목록      |    P2    |
|  U29  | 예약 내역    | 나의 예약 확인 (티켓) |    P2    |
|  U30  | 내 등록 팝업 | 내가 등록한 팝업 목록 |    P2    |
...
interface Popup {
  ...
  // 예약 관련 (New)
  isReservationRequired: boolean;   // 사전 예약 필수 여부
  admissionFee: number;             // 입장료 (0이면 무료)
  maxCapacityPerSlot?: number;      // 회차당 최대 수용 인원
  reservationOpenAt?: string;       // 예약 오픈 시점
...
interface User {
  ...
  isNotificationEnabled: boolean;   // 푸시 알림 수신 동의
...
interface Notification {
  id: string;
  userId: string;
  type: 'open_alert' | 'reservation_reminder' | 'comment_reply' | 'notice';
  title: string;
  message: string;
...
| **Toss Payments**   | 입장료 결제      |   △   |
| **Firebase FCM**    | 웹 푸시 알림     |   △   |
